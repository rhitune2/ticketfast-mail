...
import { type ticketMessage, type ticketAttachment } from "@/db-schema";

interface MessageItemProps {
  message: typeof ticketMessage.$inferSelect & {
    attachments?: (typeof ticketAttachment.$inferSelect)[]
  };
  isLatest?: boolean;
}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <div>
                  ...
                  {!message.isAgent && message.fromEmail && (
                ...
                {message.isAgent && (
                  <Badge variant="outline" className="ml-2">Team Member</Badge>
                )}
                {message.isInternal && (
